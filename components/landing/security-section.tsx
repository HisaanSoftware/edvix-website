...
const securityFeatures = [
  {
    ...
    description: "Every tutor is screened and approved before going live.",
    image: "/images/isolated.jpg",
  },
  {
    icon: Lock,
    title: "Student data privacy",
    description: "Learning records are encrypted at rest and in transit.",
    image: "/images/encrypted.jpg",
  },
  {
    icon: Eye,
    title: "Class transparency",
    description: "Parents can review attendance, class summaries, and progress logs.",
    image: "/images/audit.jpg",
  },
  {
    icon: FileCheck,
    title: "Role-based access",
    description: "Students, tutors, and parents see only what they need.",
    image: "/images/permissions.jpg",
  },
];

const certifications = ["Child Safety", "GDPR Ready", "ISO 27001", "Secure Payments"];
      ...
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
        ...
        <div className="mb-20">
          ...
          <h2 className={`text-6xl md:text-7xl lg:text-[128px] font-display tracking-tight leading-[0.9] mb-12 transition-all duration-1000 ${
            ...
            Autonomous,
            <br />
            <span className="text-muted-foreground">and parent-trusted.</span>
          </h2>
          ...
          <div className={`transition-all duration-1000 delay-100 ${
            ...
            <p className="text-xl text-muted-foreground leading-relaxed max-w-2xl">
              Edvix is built for trusted learning with verified tutors, protected student data, and complete parent visibility.
            </p>
          </div>
        </div>
          ...
          <div className={`lg:col-span-7 relative p-8 lg:p-12 border border-foreground/10 min-h-[400px] overflow-hidden transition-all duration-700 ${
            ...
            <div className="relative z-10">
              ...
              <div className="mt-8">
                ...
                <span className="block text-muted-foreground mt-2">Student safety incidents this year</span>
              </div>
            </div>
