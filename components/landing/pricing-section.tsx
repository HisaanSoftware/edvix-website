...
const plans = [
  {
    name: "Starter",
    description: "For students beginning guided tuition",
  ...
  {
    name: "Growth",
    description: "For families who want faster results",
    price: { monthly: 79, annual: 65 },
    features: [
      "Up to 3 learner profiles",
      "Live 1:1 tuition sessions",
  ...
  {
    name: "Institution",
    description: "For schools and tuition centers",
    price: { monthly: null, annual: null },
    features: [
      "Unlimited student profiles",
      "Tutor management dashboard",
      "Attendance and grading analytics",
        ...
        <div className="grid lg:grid-cols-12 gap-8 mb-20">
          <div className="lg:col-span-7">
            ...
            <h2 className={`text-6xl md:text-7xl lg:text-[128px] font-display tracking-tight leading-[0.9] transition-all duration-1000 ${
              ...
              Flexible plans
              <br />
              <span className="text-stroke">for every learner.</span>
            </h2>
          </div>
