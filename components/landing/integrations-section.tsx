...
export function IntegrationsSection() {
  ...
  return (
    <section id="integrations" ref={sectionRef} className="relative overflow-hidden pb-4 md:pb-6">
      <div
          className={` mx-auto mt-4 md:mt-6 w-[min(94vw,760px)] overflow-hidden rounded-2xl  transition-all duration-1000 delay-150 ${
        ...
        >
          ...
          >
            <source src="/Aiza.mp4" type="video/mp4" />
          </video>
        </div>

      {/* Header — centré verticalement sur l'image */}
      <div className="mb-4 md:mb-6 text-center">
        <span className={`inline-flex items-center gap-4 text-sm font-mono text-muted-foreground mb-3 transition-all duration-700 justify-center ${
        ...
        <h2 className={`text-2xl md:text-4xl lg:text-[66px] xl:text-[72px] font-display tracking-tight leading-[0.9] transition-all duration-1000 ${
          isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
        }`}>
          AI.ZA - Our 24/7
          <br />
          <span className="text-muted-foreground">Virtual Assistant.</span>
        </h2>

        <p className={`mt-3 text-xl text-muted-foreground leading-relaxed max-w-lg mx-auto transition-all duration-1000 delay-100 ${
          isVisible ? "opacity-100" : "opacity-0"
        }`}>
          "Technology enhances teaching; human connection transforms lives." AIZA is Edvix&apos;s smart virtual
          assistant designed to support students and parents anytime.
        </p>
